...
import 'package:corner_store_mobile/widgets/menu_button_cards.dart';
...
class MyHomePage extends StatelessWidget {
    ...
    final List<ItemHomepage> items = [
        ItemHomepage("View Product List", Icons.mood, Colors.red),
	...
	return Scaffold(
      ...
      appBar: AppBar(
        // The title of the application "The Corner Store" with white text and bold font.
        title: const Text(
          'The Corner Store',
          style: TextStyle(
            color: Colors.white,
